...
<!-- Rollback LUP-->
<div class="modal fade" id="modalrollbacklup{{$lupparent->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Rollback LUP</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div> 
            <form method="POST" name="frm-categorization" id="frm-categorization" class="form-horizontal" action="/lup/{{Crypt::encryptString($lupparent->id)}}/rollback">
                @csrf
                @method('put')           
                <div class="modal-body">                  
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control form-control-sm" type="text" id="note_approver" name="note_approver">{{$lupparent->note_approver}}</textarea>                                   
                        </div>                                 
                    </div>             
                    <input class="form-control form-control-sm" type="text" id="modalhidecodelup" name="modalhidecodelup" value="{{ $lupparent->code }}" hidden>
                    <input class="form-control form-control-sm" type="text" id="modalhidecode" name="modalhideidlup" placeholder="Type to edit action..." value="{{ $lupparent->id }}" hidden>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Dismiss</button>
                    <button type="submit" class="btn btn-warning" name="saveaction">Save</button>                   
                </div>   
            </form>        
      </div>
    </div>
