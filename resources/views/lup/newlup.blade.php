          ...
          <div class="card-body pt-1">
            ...
            <div class="tab-content pt-2">
                  <div class="tab-pane fade initiation pt-3" id="initiation">  <!-- Details Form -->                
                    <form id="submit-form" validate class="row g-3" method="POST" action="/lup/store">
                      ...
                      <div class="col-md-12">
                        <div class="form-floating input-sm">
                          <input type="text" class="form-control text-small" @error('documentname') is-invalid @enderror name="documentname" id="documentname" placeholder="Title" value = "{{ old('documentname') }}" required autofocus autocomplete="off">
                      ...
                      <div class="col-md-4 mb-2">
                        <label @error('lup_type') is-invalid @enderror>Change Related to :</label><br>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating input-sm">
                          <input type="text" class="form-control text-small" name="lup_subtype" id="lup_subtype" placeholder="Change Sub Category" value = "{{ old('lup_subtype') }}" autocomplete="off">
                      ...
                      <div class="col-md-4">
                        <div class="form-floating input-sm">
                            <select class="form-select" @error('duedate_type') is-invalid @enderror name="duedate_type" id="duedate_type" aria-label="Change Type" required autocomplete="off">
                                <option>{{ old('duedate_type') }}</option>
                      ...
                      <div class="col-md-4">                  
                        <div class="form-floating">
                          <input type="date" class="form-control text-small" @error('duedate_start') is-invalid @enderror name="duedate_start" id="duedate_start" placeholder="Due Date Implementation"  value = "{{ old('duedate_start') }}" required autocomplete="off">
                    ...
                    <div class="col-md-4">                  
                        <div class="form-floating">
                          <input type="date" class="form-control text-small" @error('duedate_finish') is-invalid @enderror name="duedate_finish" id="duedate_finish" value = "{{ old('duedate_finish') }}" placeholder="Due Date Finish" autocomplete="off">
                      ...
                      <div class="col-sm-4">         
                        ...
                        <div class="form-floating">
                            ...
                            <textarea  placeholder="Fill Current Condition" @error('lup_current') is-invalid @enderror name="lup_current" id="lup_current" required autocomplete="off">
                                {{ old('lup_current') }}
                      ...
                      <div class="col-sm-4">         
                        ...
                        <div class="form-floating">
                            ...
                            <textarea placeholder="Fill Proposed Change" @error('lup_proposed') is-invalid @enderror  name="lup_proposed" id="lup_proposed" required autocomplete="off">
                                {{ old('lup_proposed') }}
                              </textarea><!-- End TinyMCE Editor -->         
                          @error('lup_proposed')
                            <div class="text-danger">{{ $message }}</div>
                      ...
                      <div class="col-sm-4">         
                        ...
                        <div class="form-floating">
                            ...
                            <textarea placeholder="Fill Change Reason" @error('lup_reason') is-invalid @enderror name="lup_reason" id="lup_reason" required autocomplete="off">
                                {{ old('lup_reason') }}
                              </textarea><!-- End TinyMCE Editor -->     
                          @error('lup_reason')
                            <div class="text-danger">{{ $message }}</div>
