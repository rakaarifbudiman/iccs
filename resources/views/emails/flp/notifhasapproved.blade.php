...
@section('content')
    <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fbfbfb;" width="100%">
        ...
        <p style="margin: 0; font-size: 30px; text-align: center;">Dear All,</p>
        <p style="margin: 0; font-size: 25px; text-align: center;">FLP Berikut ini telah di Approved :</p>
        </div>
        </div>
        </td>
        </tr>
        ...
        <tr style="height: 20px;">
            <td style="width: 21.5123%; height: 21px; border-style: none;"><span style="color: #ffffff;">No. FLP&nbsp;</span></td>
            <td style="width: 38.4876%; height: 21px; border-style: none;"><span style="color: #ffffff;">: {{ $mailData['noflp'] }}</span></td>
        </tr>
        <tr style="height: 20px;">
        ...
        <tr style="height: 30px;">
            <td style="width: 21.5123%; border-style: none; height: 30px;"><span style="color: #ffffff;">Notes&nbsp;</span></td>
            <td style="width: 38.4876%; border-style: none; height: 30px;">
            <p><span style="color: #ffffff;">: {{ $mailData['notes'] }}</span></p>
            </td>
        </tr>         
