...
$(document).ready(function () {
    ...
    // Menu tab active when page reload
    ...
    if ($("[id*='Menu']").length) {
        ...
        if ($('#FLPMenu').length) {
            $('#FLPMenu a[href="#details"]').tab('show')
        }
        if ($('PartSAPMenu').length) {
            $('PartSAPMenu a[href="#basicdata"]').tab('show')
        }
    } else {
    ...
    if (activeTab) {
        $('#FLPMenu a[href="' + activeTab + '"]').tab('show');
        $('#PartSAPMenu a[href="' + activeTab + '"]').tab('show');
    } else {
        $('#FLPMenu a[href="#details"]').tab('show')
        $('#PartSAPMenu a[href="#basicdata"]').tab('show')
    }
    ...
    //autofill old_desc when old_part filled
    ...
    $(document).on('change', '#sap_prefix', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById("sap_mat_type").value = data.mat_type
                document.getElementById("sap_mat_group").value = data.mat_group
                document.getElementById("rdms_status_part").value = "OK"
                document.getElementById("sap_status_part").value = "N"
            },
            error: function (data) {
    ...
    $(".table").on('click', ':checkbox', function () {
        ...
        var id_audit = currentRow.data('value');
        var jenis = 'checkbox';
        $.ajax({
            type: 'post',
