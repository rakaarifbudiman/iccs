...
class LUPNotifHasApproved extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->subject('(WEB TESTING) Congratulation for New Approved LUP System ,for: '.$this->lup->nolup.' Rev-'.$this->lup->revision)
